...
<html lang="ru">
	...
	<body>
		<section id="set_objects" data-role = "page" data-position = "fixed" >
			...
			<form id = "objects_data" class = "data_list">
				...
				    <li data-theme = "b"><a href="#" >NEW OBJECT </a></li>
				    <li><a href="#" data-ajax = "false">Computer </a></li>
				    <li><a href="#">Santehnik </a></li>
				    <li><a href="#">Смеситель в ванной </a></li>
				</ul>
			</form>
