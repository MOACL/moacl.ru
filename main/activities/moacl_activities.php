	...
	<body>
		<section id="mact_1" data-role = "page" data-position = "fixed"  >
			<header data-role = "header">
				<h1><b>MOACL-<i>activities</i></b></h1>
				 <a href="#nav-panel" data-icon="bars" data-iconpos="notext">Menu</a>
				 <a href="moacl_activities_setting.php" data-ajax = "false" data-icon="gear" data-iconpos="notext right">Setting</a>
						...
						<tr>
							...
							<td>
								<div data-role="fieldcontain" >
									...
									<input id = "Limit" type="text" name="Limit" readonly style = "border: none "/>
								</div>
							</td>
						</tr>
					</table>
