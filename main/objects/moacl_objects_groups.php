...
<html lang="ru">
	...
	<body>
		<section id="set_groups" data-role = "page" data-position = "fixed" >
			<header data-role = "header">
			<h1><b>MOACL<i>-groups</i></b></h1>
			 <a href="moacl_objects_setting.php" data-ajax = "false" data-icon="back" data-iconpos="notext">Menu</a>
			</header>
			<form id = "groups_data" class = "data_list">
				<ul data-role="listview" data-count-theme="a" data-inset="true">
				    <li data-theme = "b"><a href="#" >NEW GROUP </a></li>
				    <li><a href="#" data-ajax = "false">Lamps </a></li>
