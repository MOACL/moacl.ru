	...
	<body>
		<section id="mobj_1" data-role = "page" data-position = "fixed"  >
			<header data-role = "header">
				<h1><b>MOACL-<i>objects-setup</i></b></h1>
				 <a href="#nav-panel" data-icon="bars" data-iconpos="notext">Menu</a>
				 <a href="moacl_objects.php" data-ajax = "false" data-icon="gear" data-iconpos="notext right">Setting</a>
			</header>
				...
				<form id = "main_form" name="main_form">
					...
					<table>
						<tr>
							...
							<td>
								<div data-role="fieldcontain" >
									<a href="moacl_objects_places.php" data-ajax = "false" class="ui-btn ui-shadow ui-corner-all ui-icon-gear ui-btn-icon-notext">Place_set</a>
								</div>
							</td>
							<td>
								<div data-role="fieldcontain" >
					...
					<table>
						<tr>
							...
							<td>
								<div data-role="fieldcontain" >
									<a href="moacl_objects_groups.php" data-ajax = "false" class="ui-btn ui-shadow ui-corner-all ui-icon-gear ui-btn-icon-notext">Group_set</a>
								</div>
							</td>
							<td>
								<div data-role="fieldcontain">
							...
							<td>
								<div data-role="fieldcontain" >
									<a href="moacl_objects_objects.php" data-ajax = "false" class="ui-btn ui-shadow ui-corner-all ui-icon-gear ui-btn-icon-notext">Object_set</a>
								</div>
							</td>
						</tr>
					</table>
